...
//        then: 삭제 결과 확인 , 200 응답코드 확인
    ...
    public void updateArticle() throws Exception{
        ...
        Article saveRequest = blogRepository.save(new Article("origin title", "origin content"));
        long id = saveRequest.getId();

        AddArticleRequest updateRequest = new AddArticleRequest("updated title", "updated content");
